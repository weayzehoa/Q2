...
(2, 1, '仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 4),
...
--
ALTER TABLE `good`
  MODIFY `g_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `user`
  MODIFY `u_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
