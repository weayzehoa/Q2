...
CREATE TABLE `good` (
  `g_seq` int(10) UNSIGNED NOT NULL,
  `g_id` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `g_n_seq` int(11) NOT NULL
...
INSERT INTO `good` (`g_seq`, `g_id`, `g_n_seq`) VALUES
(24, 'admin', 1),
(25, 'admin', 2),
(26, 'admin', 4),
(27, 'admin', 5),
...
CREATE TABLE `news` (
  ...
  `n_con` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `n_look` int(1) NOT NULL,
  `n_good` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `que` (
  `q_seq` int(10) UNSIGNED NOT NULL,
  `q_name` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `que` (`q_seq`, `q_name`) VALUES
(1, '你最常做什麼運動來促進健康體能呢?'),
(2, '二手菸沒有安全劑量，只要有暴露，就會有危險，請問它會造成身體上哪些危害?');
...
CREATE TABLE `que_option` (
  `q_o_seq` int(10) UNSIGNED NOT NULL,
  `q_n_seq` int(11) NOT NULL,
  `q_o_name` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `q_o_vote` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `que_option` (`q_o_seq`, `q_n_seq`, `q_o_name`, `q_o_vote`) VALUES
(1, 1, '健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 2),
(2, 1, '仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 5),
(3, 1, '球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 1),
(4, 1, '舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 1),
(5, 2, '增加罹患冠狀動脈心臟病及罹病死亡之風險。', 1),
(6, 2, '對孩子的的健康會產生許多影響，例如容易咳嗽或打噴嚏、罹患氣喘或讓症狀更嚴重、會因刺激耳咽管，感染中耳炎、肺功能較差、容易罹患呼吸道疾病等。', 1),
(7, 2, '孕婦吸入二手菸易造成流產、早產、胎盤早期剝離、子宮感染等疾病。', 2),
(8, 2, '長期的暴露會造成更嚴重的胸腔問題和過敏症，還會增加心臟病和肺癌的罹患率。', 3),
(9, 2, '以上皆是。', 1);
...
CREATE TABLE `user` (
  ...
  `u_pw` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `u_mail` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `user` (`u_seq`, `u_id`, `u_pw`, `u_mail`) VALUES
...
INSERT INTO `visit` (`v_seq`, `v_date`, `v_today`) VALUES
(1, '2019-02-09', 2),
(2, '2019-02-10', 8),
(3, '2019-02-08', 1),
(4, '2019-02-07', 1),
...
--
ALTER TABLE `good`
  MODIFY `g_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- 使用資料表 AUTO_INCREMENT `news`
--
ALTER TABLE `news`
  MODIFY `n_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- 使用資料表 AUTO_INCREMENT `que`
--
ALTER TABLE `que`
  MODIFY `q_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 使用資料表 AUTO_INCREMENT `que_option`
--
ALTER TABLE `que_option`
  MODIFY `q_o_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- 使用資料表 AUTO_INCREMENT `user`
--
ALTER TABLE `user`
  MODIFY `u_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- 使用資料表 AUTO_INCREMENT `visit`
--
ALTER TABLE `visit`
  MODIFY `v_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
